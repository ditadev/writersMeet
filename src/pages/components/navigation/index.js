                ...
                <header className="blog-header lh-1 py-3">
                    <div className="row flex-nowrap justify-content-between align-items-center">
                        <div className="col-4 pt-1">
                            <a className="link-secondary" href="/profile">ditadev</a>
                        </div>
                        <div className="col-4 text-center">
                            <a className="blog-header-logo text-dark" href={`/`}>WRITERSMEET</a>
                        </div>
                        <div className="col-4 d-flex justify-content-end align-items-center">
                            <a classNameclassName="link-secondary" href="#" aria-label="Search">
                                ...
                                <a className="btn btn-sm btn-outline-secondary user-login-btn" href="/signup">Sign up</a>
                                <a className="btn btn-sm btn-outline-secondary user-login-btn" href="/signin">Sign in</a>
                        </div>
                    </div>
                </header>
